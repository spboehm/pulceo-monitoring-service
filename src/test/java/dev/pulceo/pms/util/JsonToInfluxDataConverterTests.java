...
public class JsonToInfluxDataConverterTests {
    ...
    public void testConvertFromTCPBWMetric() throws IOException {
        ...
        // then
        assertEquals("TCP_BW,bandwidthUnit=Mbits/s,destinationHost=127.0.0.1,deviceId=0247fea1-3ca3-401b-8fa2-b6f83a469680,endTime=2024-01-29T10:32:58.479535020Z,iperf3Protocol=TCP,iperfRole=RECEIVER,metricType=TCP_BW,metricUUID=fee50cfc-1360-4713-a70e-a0827d2d6976,sourceHost=127.0.0.1,startTime=2024-01-29T10:32:57.465165Z bitrate=15735.0", listOfPoints.get(0).toLineProtocol());
        assertEquals("TCP_BW,bandwidthUnit=Mbits/s,destinationHost=127.0.0.1,deviceId=0247fea1-3ca3-401b-8fa2-b6f83a469680,endTime=2024-01-29T10:32:58.479535020Z,iperf3Protocol=TCP,iperfRole=SENDER,metricType=TCP_BW,metricUUID=fee50cfc-1360-4713-a70e-a0827d2d6976,sourceHost=127.0.0.1,startTime=2024-01-29T10:32:57.465165Z bitrate=15738.0", listOfPoints.get(1).toLineProtocol());
    }
    ...
    public void testConvertFromTCPRTTMetric() throws Exception {
        ...
        // then
        assertEquals("TCP_RTT,destinationHost=127.0.0.1,deviceId=0247fea1-3ca3-401b-8fa2-b6f83a469680,endTime=2024-01-29T09:07:11.725847321Z,metricType=TCP_RTT,metricUUID=cbd29b61-5955-4743-9c62-6710bf7bcab5,sourceHost=127.0.0.1,startTime=2024-01-29T09:07:11.716082302Z avgRTT=0.007,maxRTT=0.007,minRTT=0.007,tcpConnectionAttempts=1i,tcpFailedConnectionsAbsolute=0i,tcpFailedConnectionsRelative=0.0,tcpSuccessfulConnections=1i", listofPoints.get(0).toLineProtocol());
    }
 }
